     ...
     return (
         ...
         <div className={s.center}>
             ...
             <div className={s.buttons}>
                 <Button disabled={!props.disableValue || props.state >= props.max} name={'inc'} callback={()=>incHandler()} />
                 <Button disabled={!props.disableValue} name={'reset'} callback={resetHandler} />
             </div>
